...
export default function Sidebar() {
  ...
  return (
    <aside className={`dashboard-sidebar text-white min-h-screen transition-all duration-300 ease-in-out ${
      ...
      <div className="flex flex-col h-full">
        ...
        {isCollapsed && (
          <div className="p-2">
            <button
              onClick={toggleSidebar}
              className="w-full flex justify-center text-gray-400 hover:text-white transition-colors p-3 rounded-lg hover:bg-slate-700"
